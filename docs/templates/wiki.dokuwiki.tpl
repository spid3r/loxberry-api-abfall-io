...
[[https://github.com/spid3r/loxberry-api-abfall-io/releases|ZIP der aktuellen Stable-Version (GitHub Releases)]] — Versionsnummer und Änderungen siehst du auf der gleichen Seite. **Vorschau-Builds (Pre-Releases)** gibt es ebenfalls dort; Hinweise unter **„Pre-Releases und Autoupdate (Beta)“**.


===== Pre-Releases und Autoupdate (Beta) =====
...
**So probierst du Beta sinnvoll aus**
  ...
  * **Einmal** die gewünschte **Beta-ZIP** von **[[https://github.com/spid3r/loxberry-api-abfall-io/releases|GitHub Releases]]** (unter **Pre-releases**) laden bzw. die **„Installation von URL“** mit der Direkt‑Link‑URL zur ZIP nutzen ([[https://github.com/spid3r/loxberry-api-abfall-io#readme|Ausführlichere Schritte im README auf GitHub]]).
  * Danach zeigt das Plugin eine **‑beta‑…** Versionsnummer. Jetzt kannst du in der Plugin-Verwaltung **„Pre- und Releases“** aktivieren — **„Auf Aktualisierungen prüfen“** (oder den **täglichen** Check) erkennt dann **neuere** Betas (**…-beta.N+1**) wie gewohnt.
  * Für die **stabile** Leitung bleibt die normale Stable‑ZIP unter Releases; Hinweise zur LoxBerry-Autoupdate-Funktion: **[[https://wiki.loxberry.de/loxberry_english/english_faq_and_knowledge_base/automatic_and_manual_plugin_updates|Automatic and manual plugin updates]]** im LoxBerry-Wiki.

Technisch stellt das Plugin zwei Konfig‑URLs bereit (**Stable** über ''release.cfg'' auf ''main'', **Beta** über ''prerelease.cfg'' auf Branch ''beta'') — wenn du Beta nutzt, entscheidest du mit ''Pre- und Releases'', dass LoxBerry die **Beta-INI** auswertet (siehe auch die mitgelieferte ''plugin.cfg'' im ZIP).
